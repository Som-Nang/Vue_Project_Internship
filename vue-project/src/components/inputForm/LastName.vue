<template>
    <div class="col-span-2 space-y-1">
        <div class="relative flex justify-start space-y-5 border border-gray-300 px-5 py-[17.5px] pr-5 " :class="{input_frame: errors.lastName}">
            <label for="" class="absolute text-xs text-gray-500 top-0 pt-2">LAST NAME</label>
        ...
        <p class="text-sm text-red-500 text-right " v-if="errors.lastName">{{ errors.lastName }}</p>
    </div>
